const CACHE="intellitools-v2-2";
const ASSETS=["./","./index.html","./v2.css","./tools.js","./v2-tools.js","./manifest.webmanifest","./assets/icon.svg","./vendor/pdf-lib.min.js","./vendor/qrcode.min.js","./vendor/jsqr.min.js"];
